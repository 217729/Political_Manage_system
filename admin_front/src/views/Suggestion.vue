  ...
  <div class="total">
    <el-container>
      ...
      <el-main>
        ...
        <el-row>
          <el-col :span="18">
            <el-form :model="form" label-width="100px" style="margin-top:15px;margin-left:70px;margin-right: 90px;;"
              ...
              <el-row>
                ...
                <el-form-item label="联系方式" style="margin-left: 50px;">
                  <el-input v-model="form.tel" placeholder="你可以留下联系方式方便我们联系你" style="width:500px;"></el-input>
                </el-form-item></el-row>
